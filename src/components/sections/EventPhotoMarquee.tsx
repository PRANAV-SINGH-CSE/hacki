      ...
      >
        {duplicatedImages.map((image, index) => (
          ...
          >
            <button
              type="button"
              className="marquee-image-button relative h-32 sm:h-60 md:h-80 lg:h-96 aspect-[2.5/1] photo-container rounded-lg overflow-hidden bg-white/5 border border-white/10"
              onPointerDown={(event) => {
